...
public class PathfindersSorcerer extends AbstractAndoainCard {
    public static final String ID = ModHelper.makePath("PathfindersSorcerer");
    private static final String IMG_PATH = ModHelper.getCardImagePath("PathfindersSorcerer");
    ...
    private static final int MUDDY_BURN = 2;
    private static final int UPGRADE_MUDDY_BURN = 1;

    public PathfindersSorcerer() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, TYPE, COLOR, RARITY, TARGET);
        this.baseDamage = DAMAGE;
        this.magicNumber = this.baseMagicNumber = MUDDY_BURN;
        this.exhaust = true;
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            upgradeMagicNumber(UPGRADE_MUDDY_BURN);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.getMonsters().monsters.forEach(mon -> {
            if (!mon.isDeadOrEscaped()) {
                ...
                // 应用浊燃损伤
                addToBot(new ApplyMuddyBurnAction(mon, p, 1));
                addToBot(new ApplyMuddyBurnAction(mon, p, 1));
            }
        });
    ...
    public AbstractCard makeCopy() {
        return new PathfindersSorcerer();
    }
    @Override
