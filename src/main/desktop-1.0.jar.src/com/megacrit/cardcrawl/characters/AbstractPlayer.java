...
/*  916 */         this.isHoveringDropZone = (((y > this.hoverStartLine || y > 300.0F * Settings.scale) && y < Settings.CARD_DROP_END_Y) || hMonster || Settings.isControllerMode);
/*      */       } else {
/*      */         
/*  919 */         this.isHoveringDropZone = ((y > 350.0F * Settings.scale && y < Settings.CARD_DROP_END_Y) || hMonster || Settings.isControllerMode);
/*      */       } 
/*      */       
...
/* 1048 */     if (Settings.isTouchScreen && !Settings.isControllerMode && !this.isUsingClickDragControl && !InputHelper.isMouseDown) {
...
/*      */         
/* 1390 */         if (Settings.isTouchScreen && !Settings.isControllerMode && this.touchscreenInspectCount == 0) {
...
/*      */       } 
/*      */       
/* 1457 */       if (Settings.isTouchScreen && !Settings.isControllerMode) {
/* 1458 */         this.hoveredCard.target_x = InputHelper.mX;
/* 1459 */         this.hoveredCard.target_y = InputHelper.mY + 270.0F * Settings.scale;
/*      */       } else {
/* 1461 */         this.hoveredCard.target_x = InputHelper.mX;
/* 1462 */         this.hoveredCard.target_y = InputHelper.mY;
/*      */       } 
/*      */ 
/*      */       
...
/*      */         
/* 1482 */         if (Settings.isTouchScreen && !Settings.isControllerMode) {
/* 1483 */           this.hoveredCard.target_y = 260.0F * Settings.scale;
/* 1484 */           this.hoveredCard.target_x = Settings.WIDTH / 2.0F;
/* 1485 */           this.hoveredCard.targetDrawScale = 1.0F;
/*      */         } else {
/* 1487 */           this.hoveredCard.target_y = AbstractCard.IMG_HEIGHT * 0.75F / 2.5F;
/* 1488 */           this.hoveredCard.target_x = Settings.WIDTH / 2.0F;
/*      */         } 
...
/*      */     } 
/*      */     
/* 1495 */     if (this.isDraggingCard && InputHelper.justReleasedClickLeft && (!Settings.isTouchScreen || Settings.isControllerMode)) {
...
/*      */     
/*      */     }
/* 1531 */     else if (Settings.isTouchScreen && !Settings.isControllerMode && InputHelper.justReleasedClickLeft && this.hoveredCard != null) {
...
/* Location:              E:\莫单人萨米\desktop-1.0.jar!\com\megacrit\cardcrawl\characters\AbstractPlayer.class
