...
/*     */         
/* 210 */         if (plusZero
/* 211 */           .length() == formatted.length() && magicString
/* 212 */           .regionMatches(0, plusMagic, i, magicString
/* 213 */             .length()) && formattedMillis
/* 214 */           .toString().regionMatches(0, formatted, i, magicString
/* 215 */             .length()) && "000"
/* 216 */           .regionMatches(0, plusZero, i, "000"
/* 217 */             .length())) {
/* 218 */           return i;
/*     */         }
/* 220 */         return -1;
...
/* 304 */       this
/* 305 */         .millisecondStart = findMillisecondStart(now, this.cache.toString(), this.formatter);
/*     */     }
/*     */     
/* 308 */     return buf;
/*     */   }
...
/* Location:              E:\莫单人萨米\desktop-1.0.jar!\org\apache\logging\log4j\core\pattern\CachedDateFormat.class
